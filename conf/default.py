...
MIDDLEWARE_CLASSES = (
    ...
    'uam.middlewares.AccessMiddleware',  # UAM中间件
)
...
CHECK_MENU_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_check_menu_data.json')
CHECK_ITEM_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_check_item_data.json')
